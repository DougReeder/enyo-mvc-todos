...
e = arguments, n = e[0], t = this === enyo ? window : this;
while (n[r] === ".") ++r;
...
destroy: function() {
this.disconnect(), this._source = null, this._target = null, this._sourceResponder = null, this._targetResponder = null, this.isDestroyed = !0, enyo.bindingCount--;
}
}, enyo.Binding = r;
})();
...
_setup: function() {
var e, t, n, r, i, s;
this.clearBindings(), this._observers = {}, s = this._computed = {}, i = this._bindings = [];
for (e in this) {
if (!(t = this[e])) continue;
if (enyo.isFunction(t)) {
if (t.isObserver && t.events && t.events.length > 0) for (n = 0; n < t.events.length; ++n) r = t.events[n], this.addObserver(r, t); else if (t.isProperty) {
s[e] = t;
...
} else if (e === "bindings" && enyo.isArray(t)) for (n = 0; n < t.length; ++n) i.push(new enyo.Binding({
owner: this,
autoConnect: !0
}, t[n]));
}
...
var e = this._notificationQueue || {}, t, n, r, i;
for (n in e) {
r = e[n];
if (r && enyo.isArray(r)) {
i = r.length > 1 ? r.shift() : [];
while (r.length) t = r.shift(), t && enyo.isFunction(t) && t.apply(this, i);
}
}
},
binding: function() {
...
var e = this._bindings, t = 0, n;
if (e && e.length > 0) while (e.length) n = e.shift(), n.destroy();
},
get: function() {
...
enyo.isString(e) && (e = this._base = enyo._getPath(e)), e || enyo.error("enyo.Extension: cannot find base to extend from " + this.extendFrom), this._get = function() {
return enyo._getPath.apply(this, arguments);
}, this.inherited(arguments), this.createProxiedMethods();
},
createProxiedMethods: function() {
var e = this._get("methods"), t = this, n = this._base.prototype;
enyo.forEach(e, function(e) {
var r = n[e];
r && enyo.isFunction(r) && (t[e] = function() {
return n[e].apply(this._get("proxy"), arguments);
});
});
},
proxy: enyo.Computed(function() {
var e = this._get("target");
return this[e] ? this[e] : this;
}),
get: function() {
var e = this._get("proxy"), t;
return t = enyo._getPath.apply(e, arguments), !t && e !== this ? this._get.apply(this, arguments) : enyo.isFunction(t) ? t.call(e) : t;
}
});
...
generated: !1,
create: function() {
this.initStyles(), this.inherited(arguments), this.showingChanged(), this.addClass(this.kindClasses), this.addClass(this.classes), this.initProps([ "id", "content", "src", "controller" ]), this._setup(!0);
},
_setup: function(e) {
e ? (this.bindings = this._controlBindings, this.inherited(arguments)) : (!this._controlBindings && this.bindings && (this._controlBindings = enyo.clone(this.bindings), this.bindings = null), this.inherited(arguments));
},
destroy: function() {
...
t.owner = this, this.controller = t;
},
